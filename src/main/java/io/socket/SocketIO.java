...
public class SocketIO {
	...
	/**
	 * Instantiates a new socket.io connection and sets the request headers used while connecting the first time for authorizing. The object connects after calling
	...
	/**
	 * Returns the headers used while handshaking. These Properties are not necessarily the ones set by {@link #addHeader(String, String)} or {@link #SocketIO(String, Properties)}
	 * but the ones used for the handshake.
	 * 
